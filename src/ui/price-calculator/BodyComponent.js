...
const OptionalGovernmentPriceInfo = (props) => {
    if(props.info["drive_away_price"]["government_charges"]){
        return (
            <div>
                <strong><span>Government charges:</span></strong>
                <div className="row">
                    <span className="col-xs-6">Registration</span>
                    <span className="col-xs-6 price"><strong>{formatPrice(props.info["drive_away_price"]["government_charges"]["registration"]) }</strong></span>
                </div>
                <div className="row">
                    <span className="col-xs-6">Compulsory Insurance</span>
                    <span className="col-xs-6 price"><strong>{formatPrice(props.info["drive_away_price"]["government_charges"]["compulsory_insurance"])}</strong></span>
                </div>
                <div className="row">
                    <span className="col-xs-6">Stamp duty</span>
                    <span className="col-xs-6 price"><strong>{formatPrice(props.info["drive_away_price"]["government_charges"]["stamp_duty"]) }</strong></span>
                </div>
                <div className="row">
                    <p>&nbsp;</p>
                </div>
                ...
                <div className="container">
                    <div className="row image-price-row">
                        ...
                        <div className="col-md-5 col-md-pull-7 vechiclePriceBlock">
                            ...
                            <div className="modelPrice">{formatPrice(this.props.info["drive_away_price"]["drive_away_price"])} <InformationIcon onClick={() => {
                    ...
                    <div className="row">
                            ...
                            <div className="panel dealer">
                                ...
                                <div className="panel-body">
                                    <div className="split-md">
                                        ...
                                        <div className="well well-sm">
                                            <h4>Phone</h4>
                                            <a href={"tel:"+this.props.info.locations[0].phone}>{this.props.info.locations[0].phone}</a>
                                        </div>
                                        <div className="well well-sm">
                                            <h4>Opening hours</h4>
                                            <table width="60%">
                        ...
                        <div className="col-md-12 col-lg-6">
                            <div className="panel highlights">
                                <div className="panel-heading border-line" onClick={() => { this._panel.classList.toggle("expanded"); }} ref={(node) => { this._panel = node; }}>
                ...
                <div className="row-inner bottomBar">
                    <div className="container">
                        <div className="text-center">
                            {this.props.info["cta"].map((e,i) => <a href={e.url} key={i} type="button" className={"btn " + (i > 0 ? "btn-secondary" : "btn-primary")}>{e.name}</a>)}
                        </div>
                    </div>
                </div>
                <div className="row">
                        ...
                        <div className="col-xs-12">
                            <div className="priceTable border-line">
                                <div className="row">
                                    ...
                                    <span className="col-xs-6 price"><strong>{formatPrice(this.props.info["drive_away_price"]["vehicle_price"])}</strong></span>
                                </div>
                                <div className="row">
                                    <span className="col-xs-6">Dealer Delivery</span>
                                    <span className="col-xs-6 price"><strong>{formatPrice(this.props.info["drive_away_price"]["dealer_delivery"])}</strong></span>
                                </div>
